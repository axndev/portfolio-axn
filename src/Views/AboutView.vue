        ...
        <div class="mx-auto max-w-2xl lg:max-w-5xl">
          ...
          >
            ...
            <div class="lg:order-first lg:row-span-2">
              ...
              >
                I’m Kaleemullah Ahsan. I live in Kamalia, Pakistan, where I
                build websites that bring ideas to life.
              </h1>
              <div
                class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400"
              >
                <p>
                  I’ve been curious about technology for as long as I can
                  remember. As a teenager, I would spend hours
                  <b>experimenting with code</b>, breaking sites on purpose just
                  to figure out how to fix them again. What started as a game
                  quickly became an obsession the
                  <b>thrill of building something that worked</b> on a screen
                  kept me hooked.
                </p>

                <p>
                  By the time I turned 20, I had
                  <b>completed real projects for businesses</b>, designed
                  <b>portfolios for professionals</b>, and created
                  <b>tools that solved everyday problems</b>. Along the way, I
                  discovered the technologies that excited me most
                  <b>React, Vue, and Tailwind</b> and began shaping them into
                  the foundation of my work.
                </p>

                <p>
                  <b>Today, I help individuals and businesses</b> turn their
                  ideas into modern, functional websites.
                  <b>My focus is simple:</b> to craft experiences that feel
                  <b>clean, fast, and purposeful</b> sites that not only look
                  good but also truly work for the people who use them.
                </p>
              </div>
            </div>
            <div class="lg:pl-20">
