                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="max-w-2xl">
                            ...
                            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                                I’m Kaleemullah Ahsan, a frontend developer specializing in WordPress, React, and Vue.
                                I create fast, responsive, and user-friendly websites with clean design and smooth
                                functionality.
                            </p>

                            <div class="mt-6 flex gap-6"><a class="group -m-1 p-1" aria-label="Follow on X"
                                    ...
                                    </svg></a><a class="group -m-1 p-1" aria-label="Follow on Instagram" href="#"><svg
                                    ...
                                    </svg></a><a class="group -m-1 p-1" aria-label="Follow on GitHub" href="#"><svg
                                        viewBox="0 0 24 24" aria-hidden="true"
                                        class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                    ...
                                    </svg></a><a class="group -m-1 p-1" aria-label="Follow on LinkedIn" href="#"><svg
                                        viewBox="0 0 24 24" aria-hidden="true"
                                        class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                        <path
                ...
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <header class="max-w-2xl">
                            <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
                                Things I’ve made!</h1>
                            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">Many of them are open-source, so
                            ...
                            <ul role="list" class="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                                <li class="group relative flex flex-col items-start">
                                    ...
                                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                                        ...
                                        </div><a href="http://planetaria.tech"><span
                                                class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span
                                                class="relative z-10">Planetaria</span></a>
                                    </h2>
                                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Creating
                                        technology to empower civilians to explore space on their own terms.</p>
                                    <p
                                    ...
                                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                                        <div
                                            class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50">
                                                ...
                                                class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span
                                                class="relative z-10">Animaginary</span></a>
                                    </h2>
                                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">High
                                        performance web animation library, hand-written in optimized WASM.</p>
                                    <p
                                        class="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
                                        <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none">
                                            <path
                                    ...
                                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                                        <div
                                            class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50">
                                                ...
                                                class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span
                                                class="relative z-10">HelioStream</span></a>
                                    </h2>
                                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Real-time
                                        video streaming library, optimized for interstellar transmission.</p>
                                    <p
                                        class="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
                                        <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none">
                                            <path
                        ...
                        <router-link to="/projects"
                            class="px-6 py-3 m-auto flex items-center text-center w-fit gap-1 hover:gap-3 transition-all duration-100 ease-in-out mt-15 rounded-lg bg-teal-600 text-white font-medium hover:bg-teal-500">
                        ...
                        <router-link to="/blog"
                            class="px-6 py-3 mr-auto flex items-center text-center w-fit gap-1 hover:gap-3 transition-all duration-100 ease-in-out mt-15 rounded-lg bg-teal-600 text-white font-medium hover:bg-teal-500">
