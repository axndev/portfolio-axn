                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="max-w-2xl">
                            ...
                            <div class="mt-6 flex gap-6">
                                <a class="group -m-1 p-1" aria-label="Follow on X" href="https://x.com/kaleemullahahsn">
                           ...
                           <a href="https://wa.me/923190117384" target="_blank" rel="noopener"
                                class="px-6 py-3 flex items-center text-center w-fit gap-1 hover:gap-3 transition-all duration-200 ease-in-out mt-7 rounded-lg bg-teal-600 text-white font-medium hover:bg-teal-500">
                                <span>Hire Me</span>
        ...
        <div class="mt-16 sm:mt-20">
            <div class="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
                <div
                    ...
                    <img src="/banner-1.webp" alt="" loading="lazy" width="3744" height="5616" decoding="async"
                        data-nimg="1" class="absolute inset-0 h-full w-full object-cover" style="color: transparent;">
                </div>
                <div
                    class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 -rotate-2">
                    <img src="/banner-2.jpg" alt="" loading="lazy" width="3936" height="2624" decoding="async"
                        data-nimg="1" class="absolute inset-0 h-full w-full object-cover" style="color: transparent;">
                </div>
                <div
                    class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 rotate-2">
                    <img src="/banner-3.webp" alt="" loading="lazy" width="5760" height="3840" decoding="async"
                        data-nimg="1" class="absolute inset-0 h-full w-full object-cover" style="color: transparent;">
                </div>
                <div
                    class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 rotate-2">
                    <img src="/banner-4.webp" alt="" loading="lazy" width="2400" height="3000" decoding="async"
                        data-nimg="1" class="absolute inset-0 h-full w-full object-cover" style="color: transparent;">
                </div>
                <div
                    class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 -rotate-2">
                    <img alt="" src="/banner-5.jpg" loading="lazy" width="4240" height="2384" decoding="async"
                        data-nimg="1" class="absolute inset-0 h-full w-full object-cover" style="color: transparent;">
                </div>
            </div>
        </div>
