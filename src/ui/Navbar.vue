                        ...
                        <div class="mx-auto max-w-2xl lg:max-w-5xl">
                            <div class="top-(--avatar-top,--spacing(3)) w-full">
                                <div class="relative">
                                    ...
                                    <RouterLink class="block h-16 w-16 origin-left pointer-events-auto" to="/">
                                        <img src="/avatar.jpeg" alt="" width="512" height="512"
                        ...
                        <div class="mx-auto max-w-2xl lg:max-w-5xl">
                            <div class="relative flex gap-4">
                                <div class="flex flex-1">
                                    <div id="smallAvatar" :class="$route.path === '/' ? 'hidden' : ''"
                                    ...
                                    <nav class="pointer-events-auto hidden md:block">
                                        <ul
                                            ...
                                            <li><a class="relative block px-3 py-2 transition hover:text-teal-500 dark:hover:text-teal-400"
                                                    href="https://wa.me/923190117384" target="_blank"
